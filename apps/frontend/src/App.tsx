  ...
  return (
    <main className="page">
      ...
      <section className="grid" style={{ gridTemplateColumns: "1fr 1fr", gap: "20px", alignItems: "start" }}>
        ...
        {/* Left Side: Brief Form & Terminal Log */}
        ...
        {/* Right Side: Interactive Visualizer Dashboard */}
        <div className="card" style={{ margin: 0, minHeight: "680px", display: "flex", flexDirection: "column" }}>
          {!result ? (
            <div className="muted" style={{ display: "flex", flex: 1, alignItems: "center", justifyContent: "center", flexDirection: "column", gap: "10px", padding: "40px" }}>
